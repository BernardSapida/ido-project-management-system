 ...
 *   AppSelect           selectedKey      onSelectionChange
 ...
 *   AppDateField        value            onChange (CalendarDate)
...
export const Route = createFileRoute("/form-reference")({
			...
			>
				...
				<Fieldset>
					...
					<Fieldset.Group className="flex flex-col gap-4">
						{/* AppTextField - plain text, email, password, url */}
				...
				<Fieldset>
					...
					<Fieldset.Group className="flex flex-col gap-4">
						{/* AppDateField - inline date segments, no calendar popup */}
						<AppDateField
							control={control}
