...
/**
 * Close button lab - a stub. Title, scope, no specimen.
 *
 ...
 */
export const Route = createFileRoute("/(references)/components/close-button")({
	head: () => ({
		meta: [{ title: seo.title(TITLE) }, { content: "noindex", name: "robots" }],
	}),
	staticData: { breadcrumb: TITLE },
	component: CloseButtonLab,
});

function CloseButtonLab() {
	return (
		<LabStub
			description={"The dismiss affordance overlays and chips share, at the one size a thumb can still hit."}
			title={TITLE}
		/>
	);
}
