...
import { contrastOfRgb, type Rgb, reportRatio } from "../../../theme-engine";
import { AA_TEXT, NON_TEXT } from "../../../theme-engine";
	...
	return (
		...
		>
			...
			<p className="mt-1 text-muted text-xs">
				Your brand at Tailwind's eleven lightnesses, as{" "}
				<code className="font-mono">bg-app-brand-100</code>, <code className="font-mono">text-app-brand-700</code>,{" "}
				<code className="font-mono">border-app-brand-200</code>. Read off the page as painted.
			</p>
			...
			>
				{isAnchored ? (
					...
					<>
						...
						lightnesses at your hue instead. The brand itself is still{" "}
						<code className="font-mono">bg-app-brand</code>.
					</>
				)}
			</p>
